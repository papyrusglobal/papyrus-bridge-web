      ...
      if (res && res.blockNumber) {
        if (toBN(res.status).eq(toBN(1))) {
          if (this.web3Store.metamaskNet.id === this.web3Store.homeNet.id.toString()) {
            ...
            if (blockConfirmations >= this.homeRequiredBlockConfirmations) {
              this.alertStore.setBlockConfirmations(this.homeRequiredBlockConfirmations, this.homeRequiredBlockConfirmations)
              ...
              if (blockConfirmations > 0) {
                this.alertStore.setBlockConfirmations(blockConfirmations, this.homeRequiredBlockConfirmations)
              }
              this.getTxStatus(hash)
            }
            ...
            if (blockConfirmations >= this.foreignRequiredBlockConfirmations) {
              this.alertStore.setBlockConfirmations(this.foreignRequiredBlockConfirmations, this.foreignRequiredBlockConfirmations)
              this.alertStore.setLoadingStepIndex(2)
              ...
              if (blockConfirmations > 0) {
                this.alertStore.setBlockConfirmations(blockConfirmations, this.foreignRequiredBlockConfirmations)
              }
              this.getTxStatus(hash)
            }
          }
