...
class AlertStore {
  ...
  @observable requiredBlockConfirmations = 0
  ...
  setLoading(status) {
    ...
    this.requiredBlockConfirmations = 0
  }

  @action
  setBlockConfirmations(blocks, requiredBlocks) {
    this.blockConfirmations = blocks
    this.requiredBlockConfirmations = requiredBlocks
  }
